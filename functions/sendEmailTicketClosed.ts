...
// Chamado quando o admin finaliza o atendimento.
// Envia: 1 email apenas para o usuário com link para avaliação
// Proteção: campo email_conclusao_enviado evita duplicação
...
Deno.serve(async (req) => {
  ...
  if (chamado.email_conclusao_enviado) {
    console.log(`[sendEmailTicketClosed] Já enviado para chamado ${chamado_id} — ignorado`);
