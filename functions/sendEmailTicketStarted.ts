...
// Chamado quando o admin inicia o atendimento.
// Envia: 1 email apenas para o usuário
// Proteção: campo email_inicio_enviado evita duplicação
...
Deno.serve(async (req) => {
  ...
  if (chamado.email_inicio_enviado) {
    console.log(`[sendEmailTicketStarted] Já enviado para chamado ${chamado_id} — ignorado`);
