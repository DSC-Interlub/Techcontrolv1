...
export default function GerenciadorCentrosCusto() {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3 bg-card p-4 rounded-xl border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-foreground">Administração de Centros de Custo</h2>
            <p className="text-muted-foreground text-xs">Gerencie os centros de custo cadastrados para requisições de compras</p>
          </div>
        </div>
        <Button onClick={handleNew} size="sm" className="bg-emerald-600 hover:bg-emerald-700 gap-2">
      ...
      <p className="text-xs text-muted-foreground mt-2">
        {filtered.length} de {centros.length} centro(s) de custo · Centros inativos não aparecem na abertura de novas requisições.
      </p>
