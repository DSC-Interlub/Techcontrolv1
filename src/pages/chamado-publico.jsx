            ...
            body: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb;">
                ...
                <div style="background-color: white; padding: 24px; border-radius: 0 0 12px 12px; border: 1px solid #e5e7eb;">
                  ...
                  <p style="color: #374151;">Seu chamado foi registrado e em breve será atendido pela equipe de TI.</p>
                  ...
                  <div style="background-color: #fff7ed; border: 2px solid #fdba74; border-radius: 8px; padding: 16px; margin: 20px 0; text-align: center;">
                    ...
                    <p style="color: #1f2937; font-size: 28px; font-weight: bold; font-family: monospace; margin: 0;">${numeroChamado}</p>
                  ...
                  <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
                    ...
                    <tr style="background-color: #f3f4f6;">
                      <td style="padding: 8px 12px; font-size: 13px; color: #6b7280;">Descrição</td>
                      <td style="padding: 8px 12px; font-size: 13px; color: #1f2937;">${data.descricao_problema}</td>
                    </tr>
                  </table>

                  <p style="color: #6b7280; font-size: 13px; margin-top: 20px;">
                    Nossa equipe analisará sua solicitação e você receberá atualizações por e-mail conforme o andamento.
                  </p>
                </div>
              </div>
            `
