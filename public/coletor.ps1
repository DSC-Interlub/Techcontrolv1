    ...
    if ($avProducts) {
        foreach ($av in $avProducts) {
            ...
            if ($stateHex.Length -ge 4) {
                # O segundo byte indica se está ativo
...
# 6. Uptime (Tempo desde última reinicialização) com captura rica de erros
$uptimeDays = 0
$uptimeHours = 0
$uptimeStatus = "ok"
try {
...
# Montar JSON final com os valores
$result = @{
...
# Copiar JSON formatado para a área de transferência de forma automática
Set-Clipboard -Value $clipboardText

# Feedback visual para o colaborador
Write-Host "=========================================================="
